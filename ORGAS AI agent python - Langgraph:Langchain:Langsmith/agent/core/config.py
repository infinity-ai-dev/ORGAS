...
class Settings(BaseSettings):
    ...
    host: str = "0.0.0.0"
    port: int = 8000
    ai_agent_token: str = "default-dev-token"  # Bearer token for API authentication
    ...
    # Principal: Google Gemini 2.5 Pro
    gemini_model: str = "gemini-2.5-pro"  # Modelo principal
